...
![nuxthub-admin-deployments](/images/landing/nuxthub-admin-project.png){class="border rounded dark:border-gray-700 border-gray-200" data-zoom-src="/images/landing/nuxthub-admin-project.png"}
::
::div{label="Deployment Details"}
![nuxthub-admin-deployment](/images/landing/nuxthub-admin-deployment.png){class="border rounded dark:border-gray-700 border-gray-200" data-zoom-src="/images/landing/nuxthub-admin-deployment.png"}
::
::
