---
title: Setup
description: Configure your SQL database in Nuxt with Drizzle ORM, including installation, environment setup, and database connection initialization.
---
...
::callout{to="/docs/features/database/schema#schema-definition"}
