...
::callout
This solution is not perfect as it will run the migrations every time the server starts. You can improve it by keeping track of the migrations that have been applie and only run the new ones.
::
