...
NuxtHub v0.10 introduces a significant shift toward **multi-cloud support** and **self-hosting**, moving away from the Cloudflare-exclusive approach of v0.x. This guide will help you migrate your existing project.
...
| `nuxthub deploy` | Supported | Deprecated (sunset Dec 31, 2025) |
...
### From NuxtHub Admin to Self-Hosting

::warning
NuxtHub Admin will be sunset on **December 31st, 2025**. We recommend migrating to self-hosting.
::
