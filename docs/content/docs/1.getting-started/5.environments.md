...
::tabs{sync="provider"}
  ...
  **R2 Buckets:**
  ...
  ::tip
  Add storage through the [Vercel Marketplace](https://vercel.com/marketplace). By default, marketplace integrations connect to all environments—create separate storage instances per environment for isolation.
  ::
