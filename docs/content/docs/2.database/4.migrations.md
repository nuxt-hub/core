...
See the CI/CD guide for production migration workflows, including D1-specific handling and rollback strategies.
::
...
-- Use environment-specific values and hashed passwords in production
