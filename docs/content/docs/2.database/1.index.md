...
If you want to apply migrations during build, you also need to set the direct database connection string in your environment variables. With this, NuxtHub will apply migrations on build to the configured database connection.
