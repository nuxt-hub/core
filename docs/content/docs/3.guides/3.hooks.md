...
::field-group
  ...
  ::
  ::field{name="'hub:db:queries:paths'" type="(queries: string[], dialect: 'sqlite' | 'postgresql' | 'mysql') => void | Promise<void>"}
...
::field-group
  ::field{name="'hub:db:migrations:done'" type="() => void"}
...
export default defineNitroPlugin((nitroApp) => {
  nitroApp.hooks.hook('hub:db:migrations:done', () => {
