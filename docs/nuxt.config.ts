...
export default defineNuxtConfig({
  ...
  routeRules: {
    ...
    '/docs/features': { redirect: { statusCode: 301, to: '/docs/features/blob/setup' } },
    '/docs/features/blob': { redirect: { statusCode: 301, to: '/docs/features/blob/setup' } },
    '/docs/features/cache': { redirect: { statusCode: 301, to: '/docs/features/cache/setup' } },
    '/docs/features/database': { redirect: { statusCode: 301, to: '/docs/features/database/setup' } },
    '/docs/features/kv': { redirect: { statusCode: 301, to: '/docs/features/kv/setup' } },
