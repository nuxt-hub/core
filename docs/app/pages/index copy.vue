...
<template>
  <div class="relative">
    ...
    >
      <template v-if="page?.hero.headline" #headline>
        <NuxtLink :to="page.hero.headline.to">
          <UBadge color="neutral" variant="outline" size="md" class="relative px-3 rounded-full font-semibold dark:hover:bg-gray-400/15 dark:hover:ring-gray-700">
    ...
    <!-- deploy section -->
    <UPageSection :links="page?.deploy.links" class="relative">
